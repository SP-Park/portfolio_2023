...
export default function ArrowUp() {
  ...
  return (
    <div className={(scrollY? '' : 'hidden ') + 'fixed bottom-10 right-10 md:bottom-20 md:right-20'}>
        <button onClick={ScrollToTop} type="button" data-mdb-ripple="true" data-mdb-ripple-color="light" 
